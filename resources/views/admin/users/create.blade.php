...
<style>
    ...
    .adduser-wrapper {
        ...
        --c-accent:          #667eea;
        --c-accent-2:        #764ba2;
        --c-accent-soft:     rgba(102,126,234,0.12);
        --c-success:         #059669;
    ...
    /* ========== DARK THEME ========== */
    body.dark-mode .adduser-wrapper,
    body.sidebar-dark-primary .adduser-wrapper,
    [data-theme="dark"] .adduser-wrapper,
    [data-bs-theme="dark"] .adduser-wrapper {
        --card-bg:           #1e2733;
        ...
        --c-accent:          #818cf8;
        --c-accent-2:        #a78bfa;
        --c-accent-soft:     rgba(129,140,248,0.15);
        --c-success:         #10d97f;
    ...
    /* ========== BASE ========== */
    .adduser-wrapper * { box-sizing: border-box; font-family: var(--font-main); }
    .adduser-wrapper { background: transparent; padding: 0; animation: fadeIn 0.4s ease; }
    ...
    .au-header-left { display:flex; align-items:center; gap:1.2rem; }
    .au-header-icon {
    ...
    .au-alert div { display: flex; align-items: center; gap: 7px; margin-bottom: 3px; }
    .au-alert div:last-child { margin-bottom: 0; }
    ...
    /* Admin */
    .role-option.opt-admin .role-icon { background: var(--c-accent-soft); color: var(--c-accent); }
    .role-option.opt-admin input:checked + .role-label {
        border-color: var(--c-accent);
        background: var(--c-accent-soft);
        box-shadow: 0 0 0 3px var(--c-accent-soft);
    }
    /* Staff */
    .role-option.opt-staff .role-icon { background: var(--c-success-soft); color: var(--c-success); }
    .role-option.opt-staff input:checked + .role-label {
        border-color: var(--c-success);
        background: var(--c-success-soft);
        box-shadow: 0 0 0 3px var(--c-success-soft);
    }
    /* Customer */
    .role-option.opt-cust .role-icon { background: var(--c-warning-soft); color: var(--c-warning); }
    .role-option.opt-cust input:checked + .role-label {
    ...
    @media(max-width:768px){
        .au-header { padding: 1.5rem; }
        .au-header h1 { font-size: 1.5rem; }
        .au-body { padding: 0 1rem 1.5rem; }
